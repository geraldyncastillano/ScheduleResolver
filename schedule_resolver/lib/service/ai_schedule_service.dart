  ...
  Future<void> analyzeSchedule(List<TaskModel> tasks) async {
    ...
    try {
      ...
      final prompt = '''
        ...
        You are an expert student scheduling assistant. The user has provided the following tasks for their day in JSON format: $tasksJson(String Interpolation)
        ...
        Rank which tasks attention first based on the urgency, 
        importance and energy. Provide a brief reason on each.
